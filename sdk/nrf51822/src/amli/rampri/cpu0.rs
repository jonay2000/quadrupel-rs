#[doc = "Register `CPU0` reader"]
pub struct R(crate::R<CPU0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CPU0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CPU0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CPU0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CPU0` writer"]
pub struct W(crate::W<CPU0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CPU0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CPU0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CPU0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Configurable priority configuration register for CPU0.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cpu0](index.html) module"]
pub struct CPU0_SPEC;
impl crate::RegisterSpec for CPU0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cpu0::R](R) reader structure"]
impl crate::Readable for CPU0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cpu0::W](W) writer structure"]
impl crate::Writable for CPU0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CPU0 to value 0"]
impl crate::Resettable for CPU0_SPEC {
    #[inline(always)]
