...
#[doc = "Enable interrupt on ENDTX event.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum ENDTX_A {
    #[doc = "0: Interrupt disabled."]
    DISABLED = 0,
...
#[doc = "Field `ENDTX` reader - Enable interrupt on ENDTX event."]
...
#[doc = "Field `ENDTX` writer - Enable interrupt on ENDTX event."]
...
#[doc = "Enable interrupt on STARTED event.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum STARTED_A {
    #[doc = "0: Interrupt disabled."]
    DISABLED = 0,
...
#[doc = "Field `STARTED` reader - Enable interrupt on STARTED event."]
...
#[doc = "Field `STARTED` writer - Enable interrupt on STARTED event."]
