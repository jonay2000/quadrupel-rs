...
#[doc = "Field `MAXCNT` reader - Maximum number of buffer bytes to receive."]
...
#[doc = "Field `MAXCNT` writer - Maximum number of buffer bytes to receive."]
...
impl R {
    #[doc = "Bits 0:7 - Maximum number of buffer bytes to receive."]
    #[inline(always)]
