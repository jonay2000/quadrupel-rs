...
#[doc = "Field `MAXCNT` reader - Maximum number of buffer bytes to send."]
...
#[doc = "Field `MAXCNT` writer - Maximum number of buffer bytes to send."]
...
impl R {
    #[doc = "Bits 0:7 - Maximum number of buffer bytes to send."]
    #[inline(always)]
