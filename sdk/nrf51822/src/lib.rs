#![doc = "Peripheral access API for NRF51 microcontrollers (generated using svd2rust v0.22.2 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl AMLI {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const amli::RegisterBlock = 0x4000_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
impl core::fmt::Debug for AMLI {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AMLI").finish()
    }
}
#[doc = "AHB Multi-Layer Interface."]
pub mod amli;
...
impl SPIM1 {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const spim1::RegisterBlock = 0x4000_4000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
