...
use nrf51_pac::{GPIOTE, Interrupt, Peripherals, PPI, interrupt};
use crate::Level;
...
impl Motors {
    ...
    pub fn initialize(timer1: nrf51_pac::TIMER1, timer2: nrf51_pac::TIMER2, nvic: &mut NVIC, ppi: &mut PPI, gpiote: &mut GPIOTE, pin20: P0_20<Disconnected>) -> &'static CSCell<Self> {
        // Configure gpiote
        ...
        MOTORS.initialize(CSCell::new(Motors { motor_values: [0; 4], timer1, timer2, pin20 }))
    }
